...
- **Warning:** Amber (#f59e0b) - Limits, Pending
- **Error:** Red (#ef4444) - Crashes, Blocked

## Component Library (Shadcn/UI)
- **NeuralInput:** Multi-modal textarea with mic/camera/upload buttons.
...
- **Desktop:** Multi-column dashboard, sidebar nav, hover states.
